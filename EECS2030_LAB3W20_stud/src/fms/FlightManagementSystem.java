...
public class FlightManagementSystem {
	...
	public ArrayList<String> getPassengerNames(Integer id) {
		...
		Collection<PassengerInfo> p =passengers.values();// changing values into arraylist
		
		ArrayList<PassengerInfo> listOfValues = new ArrayList<PassengerInfo>(p);// changing values into arraylist
	...
	public PassengerInfo[] getSortedPassengerInfo() {
		...
		PassengerInfo[] narr= new PassengerInfo [listOfValues.size()];
		for(int i =0;i<narr.length;i++) {
			narr[i]=listOfValues.get(i);
		}
