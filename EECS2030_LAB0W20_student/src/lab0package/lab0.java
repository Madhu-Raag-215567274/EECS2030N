...
public class lab0 {
	...
	*/
	public static int[] reverseOf(int[] inputarray) {
		int [] rev=new int [inputarray.length];

		int k=inputarray.length;
		for(int i =0; i<inputarray.length;i++) {
			
			rev[k-1]= inputarray[i];
			k--;
		}
    ...
    public static int contains1(double x, Range range) {
    	if(range.getMinimum()<x && range.getMaximum()>x) {
    		return 1;
    	}
		return 0;
    ...
    public static int compareTo(Range r1, Range r2) {
    	int r1width = (int) (r1.getMaximum() - r1.getMinimum());
		int r2width = (int) (r2.getMaximum() - r2.getMinimum());
		if (r1width == r2width) {
			return 0;
