...
FlightManagementSystem db;
	...
	@Test 
	public void GetPassengName() throws IdNotFoundException {
		try {
			db.addPassenger("e6", new PassengerInfo("Heeyeon"	, 10, 2000));
			
			assertEquals( "Heeyeon", db.getPassengerName("e6"));
			//fail();
		} catch (IdAlreadyExistsExceptoin e) {
	...
	public void addtest() {
			...
			try {
				db.addFlight(2517, new FlightInfo("PUBLIC TRANSPORT", "BRITISH AIRWAYS"));
				db.addFlight(2517, new FlightInfo("NAME", "AIRLINES"));
				fail();
